...
ActiveRecord::Schema.define(version: 2022_03_15_032525) do
  ...
  create_table "secret_menu_items", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "menu_name"
  ...
  create_table "tutos", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
